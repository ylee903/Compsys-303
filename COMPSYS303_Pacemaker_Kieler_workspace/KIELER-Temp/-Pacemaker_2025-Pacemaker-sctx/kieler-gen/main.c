...
void sendVariables(int send_interface) {
    ...
    // Send A_EVT
    cJSON_AddItemToObject(root, "A_EVT", cJSON_CreateBool(model.A_EVT));
    // Send A_REFR
    cJSON_AddItemToObject(root, "A_REFR", cJSON_CreateBool(model.A_REFR));
    // Send V_EVT
    cJSON_AddItemToObject(root, "V_EVT", cJSON_CreateBool(model.V_EVT));
    // Send V_REFR
    cJSON_AddItemToObject(root, "V_REFR", cJSON_CreateBool(model.V_REFR));
    // Send _GO
    ...
    // Send _g136_e2
    cJSON_AddItemToObject(root, "_g136_e2", cJSON_CreateBool(model._g136_e2));
    // Send _g137
    ...
    // Send _g13_e1
    cJSON_AddItemToObject(root, "_g13_e1", cJSON_CreateBool(model._g13_e1));
    // Send _g14
    ...
    // Send _g201
    cJSON_AddItemToObject(root, "_g201", cJSON_CreateBool(model._g201));
    // Send _g21
    cJSON_AddItemToObject(root, "_g21", cJSON_CreateBool(model._g21));
    // Send _g213
    cJSON_AddItemToObject(root, "_g213", cJSON_CreateBool(model._g213));
    // Send _g217
    cJSON_AddItemToObject(root, "_g217", cJSON_CreateBool(model._g217));
    // Send _g22
    ...
    // Send _g42_e1
    cJSON_AddItemToObject(root, "_g42_e1", cJSON_CreateBool(model._g42_e1));
    // Send _g43
    ...
    // Send _g51_e2
    cJSON_AddItemToObject(root, "_g51_e2", cJSON_CreateBool(model._g51_e2));
    // Send _g52
    ...
    // Send _g73_e1
    cJSON_AddItemToObject(root, "_g73_e1", cJSON_CreateBool(model._g73_e1));
    // Send _g74
    ...
    // Send _g83_e2
    cJSON_AddItemToObject(root, "_g83_e2", cJSON_CreateBool(model._g83_e2));
    // Send _g84
    ...
    // Send _g97_e1
    cJSON_AddItemToObject(root, "_g97_e1", cJSON_CreateBool(model._g97_e1));
    // Send _g98
    ...
    // Send _pg101
    cJSON_AddItemToObject(root, "_pg101", cJSON_CreateBool(model._pg101));
    // Send _pg111
    ...
    // Send _pg131
    cJSON_AddItemToObject(root, "_pg131", cJSON_CreateBool(model._pg131));
    // Send _pg137
    cJSON_AddItemToObject(root, "_pg137", cJSON_CreateBool(model._pg137));
    // Send _pg13_e1
    cJSON_AddItemToObject(root, "_pg13_e1", cJSON_CreateBool(model._pg13_e1));
    // Send _pg140
    ...
    // Send _pg152
    cJSON_AddItemToObject(root, "_pg152", cJSON_CreateBool(model._pg152));
    // Send _pg154
    ...
    // Send _pg160
    cJSON_AddItemToObject(root, "_pg160", cJSON_CreateBool(model._pg160));
    // Send _pg163
    ...
    // Send _pg42_e1
    cJSON_AddItemToObject(root, "_pg42_e1", cJSON_CreateBool(model._pg42_e1));
    // Send _pg52
    ...
    // Send _pg83_e2
    cJSON_AddItemToObject(root, "_pg83_e2", cJSON_CreateBool(model._pg83_e2));
    // Send _pg98
    cJSON_AddItemToObject(root, "_pg98", cJSON_CreateBool(model._pg98));
    // Send _pre_AP
    cJSON_AddItemToObject(root, "_pre_AP", cJSON_CreateBool(model._pre_AP));
    // Send _pre_VP
    cJSON_AddItemToObject(root, "_pre_VP", cJSON_CreateBool(model._pre_VP));
    // Send _reg_AP
    cJSON_AddItemToObject(root, "_reg_AP", cJSON_CreateBool(model._reg_AP));
    // Send _reg_VP
    cJSON_AddItemToObject(root, "_reg_VP", cJSON_CreateBool(model._reg_VP));
    // Send _region0_VRefrac_t
    cJSON_AddItemToObject(root, "_region0_VRefrac_t", cJSON_CreateNumber(model._region0_VRefrac_t));
    // Send _region1_ARefrac_t
    cJSON_AddItemToObject(root, "_region1_ARefrac_t", cJSON_CreateNumber(model._region1_ARefrac_t));
    // Send _region2_AEI_t
    cJSON_AddItemToObject(root, "_region2_AEI_t", cJSON_CreateNumber(model._region2_AEI_t));
    // Send _region3_AVI_t
    cJSON_AddItemToObject(root, "_region3_AVI_t", cJSON_CreateNumber(model._region3_AVI_t));
    // Send _region4_LRI_t
    cJSON_AddItemToObject(root, "_region4_LRI_t", cJSON_CreateNumber(model._region4_LRI_t));
    // Send _region5_URI_t
    cJSON_AddItemToObject(root, "_region5_URI_t", cJSON_CreateNumber(model._region5_URI_t));
